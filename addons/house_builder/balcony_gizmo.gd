...
func _redraw(gizmo: EditorNode3DGizmo) -> void:
	...
	if n.has_stairs():
		var frame: Transform3D=n.stair_frame()
		for x in [-n.stair_actual_width()*0.5,n.stair_actual_width()*0.5]:
			lines.append(frame*Vector3(x,0,0)); lines.append(frame*Vector3(x,n.stair_ground()-n.effective_elevation(),n.stair_run()))
