...
func _redraw(gizmo: EditorNode3DGizmo) -> void:
	...
	if node.get_parent()!=null and node.get_parent().get("show_zones")==false: return
	var lines := PackedVector3Array(); var handles := PackedVector3Array(); var ids := PackedInt32Array()
