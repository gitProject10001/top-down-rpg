...
func run() -> void:
	var example=load("res://scenes/dev/castle_linked_courtyard_example.tscn").instantiate()
	...
	if DisplayServer.get_name()!="headless":
		...
		root.get_texture().get_image().save_png("res://captures/balcony_attachment/linked_courtyard_play.png")
	...
	print("LINKED_COURTYARD_KEEP_THREE_FLOORS_EXIT_OK")
