...
func run() -> void:
	var example=load("res://scenes/dev/roof_access_example.tscn").instantiate()
	...
	if DisplayServer.get_name()!="headless":
		...
		root.get_texture().get_image().save_png("res://captures/balcony_attachment/roof_access_play.png")
	...
	print("ROOF_ACCESS_REAL_PLAYER_ASCEND_OUTDOORS_DESCEND_OK")
	play.queue_free()
