...
func run() -> void:
	...
	var label := Label.new(); label.text="R03.2 · TERRAZZA CON RAMPA\nQuota +3 m · rampa 6 × 3 m · varco nel bordo"; label.position=Vector2(30,30); label.add_theme_font_size_override("font_size",20); ui.add_child(label)
